...
const messages = {
  en: {
    ...
    header_title_category_type: "%s1 %s2 - AI Poem Generator",
    header_title_poem_type: "A Poem About “%s” - AI Poem Generator",
    header_title_poem: "Discover %s high-quality AI-generated poems - AI Poem Generator",
    Description_poem_type: "Discover this poem on AI Poem Generator, a poem journey. Create an unique rhyming poem with free AI magic here",
    Description_category_type: "Discover %s1 %s2 generated by AI Poem Generator. Create unique rhyming poem with AI magic for free now!",
    ...
    Description_poem: "Discover %s high-quality AI-generated poems. Create unique poems on any theme you want instantly, free to use. Create and enjoy wonderful poems now!",
...
<h1>Is AI Poem Generator free?</h1>
<p>Yes, it's completely free. You can create unlimited poems using AI Poem Generator</p>

<h1>How fast is the poem generation speed of AI Poem Generator?</h1>
<p>Very fast. Using AI Poem Generator, a poem is usually created for you in seconds</p>

<h1>What languages does AI Poem Generator support?</h1>
<p>AI Poem Generator supports poetry creation in English, French, Russian, German, Italian, Spanish, Portuguese, Japanese, Korean, Thai, Indonesian, Vietnamese, Arabic, and Turkish</p>

<h1>How does AI Poem Generator work?</h1>
<p>AI Poem Generator uses the power of AI to help everyone easily write high-quality poems</p>

<h1>How to use the poems generated by AI Poem Generator?</h1>
<p>After generating a poem using AI Poem Generator, click the copy button to copy the poem and then paste it to any platform you want to send it to.</p>`
  ...
  fr: {
    ...
    header_title_category_type: "%s1 %s2 - Générateur de poèmes",
    header_title_poem_type: "Un poème sur « %s » - Générateur de poèmes",
    header_title_poem: "%s poèmes de haute qualité générés par l'IA - Générateur de poèmes",
    Description_poem_type: "Découvrez ce poème sur Générateur de poèmes, un voyage poétique. Créez un poème rimé unique avec la magie de l'IA gratuite ici",
    Description_category_type: "Découvrez %s1 %s2 de haute qualité. Créez gratuitement un poème de rimes unique avec la magie de l'IA dès maintenant !",
    ...
    Description_poem: "Découvrez %s poèmes de haute qualité générés par l'IA. Créez gratuitement des poèmes rimés uniques. Créez et appréciez de merveilleux poèmes maintenant !",
...
<h1>Générateur de poème est-il gratuit ?</h1>
<p>Oui, c'est totalement gratuit. Vous pouvez créer un nombre illimité de poèmes en utilisant Générateur de poème</p>

<h1>Quelle est la vitesse de génération de poèmes de Générateur de poème ?</h1>
<p>Très vite. En utilisant Générateur de poème, un poème est généralement créé pour vous en quelques secondes</p>

<h1>Quelles langues sont prises en charge par Générateur de poème ?</h1>
<p>Générateur de poème prend en charge la création de poésie en anglais, français, russe, allemand, italien, espagnol, portugais, japonais, coréen, thaï, indonésien, vietnamien, arabe et turc.</p>

<h1>Comment fonctionne Générateur de poème ?</h1>
<p>Générateur de poème utilise la puissance de l'IA pour aider tout le monde à écrire facilement des poèmes de haute qualité</p>

<h1>Comment utiliser les poèmes générés par Générateur de poème ?</h1>
<p>Après avoir généré un poème à l'aide de Générateur de poème, cliquez sur le bouton Copier pour copier le poème, puis collez-le sur la plateforme à laquelle vous souhaitez l'envoyer.</p>`,
  },
  de: {
    ...
    header_title_category_type: "%s1 %s2 - Gedichten Generator",
    header_title_poem_type: "Ein Gedicht über „%s“ – Gedichten Generator",
    header_title_poem: "Entdecken Sie %s hochwertige KI-generierte Gedichte - Gedichten Generator",
    Description_poem_type: "Entdecken Sie dieses Gedicht auf Gedichten Generator, einer Gedichtreise. Erstellen Sie hier ein einzigartiges Reimgedicht mit kostenloser KI-Magie",
    Description_category_type: "Entdecken Sie %s1 hochwertige %s2. Erstellen Sie jetzt kostenlos ein einzigartiges Reimgedicht mit KI-Magie!",
    ...
    Description_poem: "Entdecken Sie %s hochwertige KI-generierte Gedichte. Erstellen Sie kostenlos einzigartige Reimgedichte. Erstellen und genießen Sie jetzt wundervolle Gedichte!",
...
<h1>Ist Gedichten Generator kostenlos?</h1>
<p>Ja, es ist völlig kostenlos. Sie können mit Gedichten Generator unbegrenzt viele Gedichte erstellen.</p>

<h1>Wie schnell ist die Gedichtgenerierungsgeschwindigkeit von Gedichten Generator?</h1>
<p>Sehr schnell. Mit Gedichten Generator wird normalerweise in Sekundenschnelle ein Gedicht für Sie erstellt.</p>

<h1>Welche Sprachen unterstützt Gedichten Generator?</h1>
<p>Gedichten Generator unterstützt die Erstellung von Gedichten in Englisch, Französisch, Russisch, Deutsch, Italienisch, Spanisch, Portugiesisch, Japanisch, Koreanisch, Thailändisch, Indonesisch, Vietnamesisch, Arabisch und Türkisch.</p>

<h1>Wie funktioniert Gedichten Generator?</h1>
<p>Gedichten Generator nutzt die Leistungsfähigkeit der KI, um jedem zu helfen, problemlos hochwertige Gedichte zu schreiben.</p>

<h1>Wie verwende ich die von Gedichten Generator generierten Gedichte?</h1>
<p>Nachdem Sie mit Gedichten Generator ein Gedicht erstellt haben, klicken Sie auf die Schaltfläche „Kopieren“, um das Gedicht zu kopieren und es dann auf einer beliebigen Plattform einzufügen, an die Sie es senden möchten.</p>`
  ...
  ru: {
    ...
    header_title_category_type: "%s1 %s2 - Генератор стихов",
    header_title_poem_type: "Стихотворение о «%s» - Генератор стихов",
    header_title_poem: "%s хороших стихов, созданных искусственным интеллектом - Генератор стихов",
    Description_poem_type: "Откройте для себя это стихотворение на Генератор стихов, стихотворном путешествии. Создайте уникальное рифмованное стихотворение с помощью бесплатной магии AI здесь",
    Description_category_type: "Откройте для себя %s1 высококачественных %s2. Создайте уникальное рифмованное стихотворение с бесплатным AI прямо сейчас!",
    ...
    Description_poem: "Откройте для себя %s высококачественных стихотворений, созданных искусственным интеллектом. Создавайте уникальные рифмованные стихи мгновенно и бесплатно. Создавайте и наслаждайтесь прекрасными стихами прямо сейчас!",
...
<h1>Является ли Генератор Стихов бесплатным?</h1>
<p>Да, это совершенно бесплатно. Вы можете создавать неограниченное количество стихов с помощью Генератор Стихов.</p>

<h1>Насколько быстро генерируется стихотворение Генератор Стихов?</h1>
<p>Очень быстро. С помощью Генератор Стихов стихотворение обычно создается за считанные секунды.</p>

<h1>Какие языки поддерживает Генератор Стихов?</h1>
<p>Генератор Стихов поддерживает создание стихов на английском, французском, русском, немецком, итальянском, испанском, португальском, японском, корейском, тайском, индонезийском, вьетнамском, арабском и турецком языках.</p>

<h1>Как работает Генератор Стихов?</h1>
<p>Генератор Стихов использует возможности искусственного интеллекта, чтобы помочь каждому легко писать высококачественные стихи.</p>

<h1>Как использовать стихи, созданные Генератор Стихов?</h1>
<p>После создания стихотворения с помощью Генератор Стихов нажмите кнопку «Копировать», чтобы скопировать стихотворение, а затем вставьте его на любую платформу, на которую вы хотите его отправить.</p>`
  ...
  it: {
    ...
    header_title_category_type: "%s1 %s2 - Generatore di poesie",
    header_title_poem_type: "Una poesia su “%s” - Generatore di poesie",
    header_title_poem: "Esplora %s poesie generate da AI - Generatore di poesie",
    Description_poem_type: "Scopri questa poesia su Generatore di poesie, un viaggio poetico. Crea una poesia in rima unica con la magia gratuita dell'intelligenza artificiale qui",
    Description_category_type: "Scopri %s1 %s2 di alta qualità. Crea subito una poesia in rima unica con la magia dell'intelligenza artificiale gratuitamente!",
    ...
    Description_poem: "Scopri %s poesie di alta qualità generate dall'intelligenza artificiale. Crea istantaneamente poesie in rima uniche, utilizzabili gratuitamente. Crea e goditi meravigliose poesie adesso!",
...
<h1>Generatore di poesie è gratuito?</h1>
<p>Sì, è completamente gratuito. Puoi creare poesie illimitate utilizzando Generatore di poesie</p>

<h1>Quanto è veloce la generazione di poesie di Generatore di poesie?</h1>
<p>Molto veloce. Utilizzando Generatore di poesie, di solito viene creata una poesia per te in pochi secondi</p>

<h1>Quali lingue supporta Generatore di poesie?</h1>
<p>Generatore di poesie supporta la creazione di poesie in inglese, francese, russo, tedesco, italiano, spagnolo, portoghese, giapponese, coreano, tailandese, indonesiano, vietnamita, arabo e turco</p>

<h1>Come funziona Generatore di poesie?</h1>
<p>Generatore di poesie utilizza la potenza dell'intelligenza artificiale per aiutare tutti a scrivere facilmente poesie di alta qualità</p>

<h1>Come utilizzare le poesie generate da Generatore di poesie?</h1>
<p>Dopo aver generato una poesia utilizzando Generatore di poesie, fai clic sul pulsante Copia per copiare la poesia e quindi incollarla su qualsiasi piattaforma a cui desideri inviarla.</p>`
  ...
  pt: {
    ...
    header_title_category_type: "%s1 %s2 - Gerador de Poemas",
    header_title_poem_type: "Um poema sobre “%s” - Gerador de poemas",
    header_title_poem: "Explore %s poemas gerados por IA - Gerador de Poemas",
    Description_poem_type: "Descubra este poema em Gerador de poemas, uma viagem de poemas. Crie um poema rimado exclusivo com magia de IA gratuita aqui",
    Description_category_type: "Descubra %s1 %s2 de alta qualidade. Crie um poema rimado exclusivo com magia de IA gratuitamente agora!",
    ...
    Description_poem: "Descubra %s poemas gerados por IA de alta qualidade. Crie poemas rimados exclusivos instantaneamente e de uso gratuito. Crie e desfrute de poemas maravilhosos agora!",
...
<h1>O Gerador de Poemas é gratuito?</h1>
<p>Sim, é totalmente gratuito. Você pode criar poemas ilimitados usando Gerador de Poemas</p>

<h1>Qual é a velocidade de geração de poemas do Gerador de Poemas?</h1>
<p>Muito rápido. Usando o Gerador de Poemas, um poema geralmente é criado para você em segundos</p>

<h1>Quais idiomas o Gerador de Poemas suporta?</h1>
<p>Gerador de Poemas suporta a criação de poesia em inglês, francês, russo, alemão, italiano, espanhol, português, japonês, coreano, tailandês, indonésio, vietnamita, árabe e turco</p>

<h1>Como funciona o Gerador de Poemas?</h1>
<p>Gerador de Poemas usa o poder da IA para ajudar todos a escrever poemas de alta qualidade com facilidade</p>

<h1>Como usar os poemas gerados pelo Gerador de Poemas?</h1>
<p>Após gerar um poema usando o Gerador de Poemas, clique no botão copiar para copiar o poema e cole-o em qualquer plataforma para a qual deseja enviá-lo.</p>`
  ...
  es: {
    ...
    header_title_category_type: "%s1 %s2 - Generador de poemas",
    header_title_poem_type: "Un poema sobre “%s” - Generador de poemas",
    header_title_poem: "%s poemas de alta calidad generados por IA - Generador de poemas",
    Description_poem_type: "Descubra este poema en Generador de poemas, un viaje poético. Cree un poema único con rimas con la magia de la IA gratis aquí",
    Description_category_type: "Descubra %s1 %s2 de alta calidad. ¡Crea un poema que rima único con magia de IA gratis ahora!",
    ...
    Description_poem: "Descubra %s poemas de alta calidad generados por IA. Crea poemas que riman únicos al instante, de uso gratuito. ¡Crea y disfruta de maravillosos poemas ahora!",
...
<h1>¿El Generador de Poemas es gratuito?</h1>
<p>Sí, es completamente gratis. Puedes crear poemas ilimitados usando el Generador de Poemas</p>

<h1>¿Qué tan rápida es la velocidad de generación de poemas del Generador de Poemas?</h1>
<p>Muy rapido. Con el Generador de Poemas, generalmente se crea un poema en segundos</p>

<h1>¿Qué idiomas admite el Generador de Poemas?</h1>
<p>Generador de Poemas admite la creación de poesía en inglés, francés, ruso, alemán, italiano, español, portugués, japonés, coreano, tailandés, indonesio, vietnamita, árabe y turco.</p>

<h1>¿Cómo funciona el Generador de Poemas?</h1>
<p>Generador de Poemas utiliza el poder de la IA para ayudar a todos a escribir fácilmente poemas de alta calidad</p>

<h1>¿Cómo utilizar los poemas generados por Generador de Poemas?</h1>
<p>Después de generar un poema usando el Generador de Poemas, haga clic en el botón copiar para copiar el poema y luego péguelo en cualquier plataforma a la que desee enviarlo.</p>`
  ...
  ja: {
    ...
    header_title_category_type: "%s1 %s2 - AI詩ジェネレーター",
    header_title_poem_type: "「%s」についての詩 - AI 詩ジェネレーター",
    header_title_poem: "AI によって生成された %s 高品質の詩 - AI 詩ジェネレーター",
    Description_poem_type: "この詩を「AI 詩ジェネレーター」で見つけてください。詩の旅です。無料の AI マジックでユニークな韻詩をここで作成しましょう。",
    Description_category_type: "%s1の高品質な%s2を発見してください。 AI マジックを使ってユニークな韻を踏む詩を今すぐ無料で作成しましょう!",
    ...
    Description_poem: "AI によって生成された %s の高品質の詩を発見してください。 韻を踏むユニークな詩を即座に無料で作成できます。 素晴らしい詩を今すぐ作成して楽しんでください!",
    ...
    <h1>AI詩ジェネレーターは無料ですか?</h1>
<p>はい、完全に無料です。AI詩ジェネレーターを使用して無制限に詩を作成できます</p>

<h1>AI詩ジェネレーターの詩生成速度はどのくらいですか?</h1>
<p>非常に高速です。AI詩ジェネレーターを使用すると、通常、数秒で詩が作成されます</p>

<h1>AI詩ジェネレーターはどの言語をサポートしていますか?</h1>
<p>AI詩ジェネレーターは、英語、フランス語、ロシア語、ドイツ語、イタリア語、スペイン語、ポルトガル語、日本語、韓国語、タイ語、インドネシア語、ベトナム語、アラビア語、トルコ語での詩の作成をサポートしています</p>

<h1>AI詩ジェネレーターはどのように機能しますか?</h1>
<p>AI詩ジェネレーターは、AI の力を利用して、誰もが簡単に高品質の詩を書けるようにします</p>

<h1>AI詩ジェネレーターで生成された詩の使用方法は?</h1>
<p>AI詩ジェネレーターを使用して詩を生成した後、コピーボタンをクリックして詩をコピーし、送信先のプラットフォームに貼り付けます。</p>`
    
  },
  ko: {
    header_title: "AI 시 생성기 - 무료 AI 시 생성기로 운율이 맞는 시를 만들어 보세요.",
    header_title_category: "모든 시 카테고리 - AI 시 생성기",
    header_title_category_type: "%s1 %s2 - AI 시 생성기",
    header_title_poem_type: "%s에 관한 시 - AI 시 생성기",
    header_title_poem: "AI가 생성한 %s개의 고품질 시 - AI 시 생성기",
    Description_poem_type: "AI 시 생성기 에서 이 시를 발견하세요. 시 여행입니다. 무료 AI 마법으로 독특한 운율 시를 만들어 보세요.",
    Description_category_type: "%s1 고품격 %s2를 만나보세요. 지금 무료로 AI 마법으로 독특한 운율의 시를 만들어 보세요!",
    ...
    Description_poem: "AI가 만든 고품질 시 %s편을 찾아보세요. 무료로 즉시 독특한 운율의 시를 만들어 보세요. 지금 멋진 시를 만들고 즐겨보세요!",
    ...
    <h1>AI 시 생성기는 무료인가요?</h1>
<p>예, 완전 무료입니다. AI 시 생성기를 사용하면 무제한으로 시를 만들 수 있습니다.</p>

<h1>AI 시 생성기의 시 생성 속도는 얼마나 되나요?</h1>
<p>매우 빠릅니다. AI 시 생성기를 사용하면 일반적으로 몇 초 안에 시가 만들어집니다.</p>

<h1>AI 시 생성기는 어떤 언어를 지원하나요?</h1>
<p>AI 시 생성기는 영어, 프랑스어, 러시아어, 독일어, 이탈리아어, 스페인어, 포르투갈어, 일본어, 한국어, 태국어, 인도네시아어, 베트남어, 아랍어, 터키어로 시 창작을 지원합니다.</p>

<h1>AI 시 생성기는 어떻게 작동하나요?</h1>
<p>AI 시 생성기는 AI의 힘을 활용하여 누구나 쉽게 고품질의 시를 쓸 수 있도록 도와줍니다.</p>

<h1>AI 시 생성기로 생성된 시를 어떻게 사용하나요?</h1>
<p>AI 시 생성기를 사용하여 시를 생성한 후 복사 버튼을 클릭하여 시를 복사한 다음 보내고 싶은 플랫폼에 붙여넣습니다.</p>`
  },
  th: {
    header_title: "ตัวสร้างบทกวี AI - สร้างบทกวีคล้องจองด้วยเครื่องสร้างบทกวี AI ฟรี",
    header_title_category: "หมวดหมู่บทกวีทั้งหมด - ตัวสร้างบทกวี AI ",
    header_title_category_type: "%s1 %s2 - ตัวสร้างบทกวี AI",
    header_title_poem_type: "บทกวีเกี่ยวกับ “%s” - ตัวสร้างบทกวี AI",
    header_title_poem: "%s บทกวีคุณภาพสูงที่สร้างโดย AI - ตัวสร้างบทกวี AI",
    Description_poem_type: "ค้นพบบทกวีนี้บน ตัวสร้างบทกวี AI การเดินทางแห่งบทกวี สร้างบทกวีสัมผัสที่เป็นเอกลักษณ์ด้วยเวทมนตร์ AI ฟรีที่นี่",
    Description_category_type: "ค้นพบ %s2 คุณภาพสูง %s1 สร้างบทกวีคล้องจองที่ไม่ซ้ำใครด้วยเวทมนตร์ AI ได้ฟรีทันที!",
    ...
    Description_poem: "ค้นพบบทกวีคุณภาพสูงที่สร้างโดย AI จำนวน %s บท สร้างบทกวีคล้องจองที่ไม่ซ้ำใครได้ทันที ใช้งานได้ฟรี สร้างและเพลิดเพลินไปกับบทกวีที่ยอดเยี่ยมตอนนี้!",
    ...
    <h1>ตัวสร้างบทกวี AI ฟรีหรือไม่</h1>
<p>ใช่ มันฟรีอย่างสมบูรณ์ คุณสามารถสร้างบทกวีได้ไม่จำกัดโดยใช้ ตัวสร้างบทกวี AI</p>

<h1>ความเร็วในการสร้างบทกวีของ ตัวสร้างบทกวี AI เร็วแค่ไหน?</h1>
<p>เร็วมาก. เมื่อใช้ ตัวสร้างบทกวี AI บทกวีจะถูกสร้างขึ้นสำหรับคุณภายในไม่กี่วินาที</p>

<h1>ตัวสร้างบทกวี AI รองรับภาษาใดบ้าง?</h1>
<p>ตัวสร้างบทกวี AI รองรับการสร้างบทกวีในภาษาอังกฤษ ฝรั่งเศส รัสเซีย เยอรมัน อิตาลี สเปน โปรตุเกส ญี่ปุ่น เกาหลี ไทย อินโดนีเซีย เวียดนาม อาหรับ และตุรกี</p>

<h1>ตัวสร้างบทกวี AI ทำงานอย่างไร</h1>
<p>ตัวสร้างบทกวี AI ใช้พลังของ AI เพื่อช่วยให้ทุกคนเขียนบทกวีคุณภาพสูงได้อย่างง่ายดาย</p>

<h1>จะใช้บทกวีที่สร้างโดย ตัวสร้างบทกวี AI ได้อย่างไร</h1>
<p>หลังจากสร้างบทกวีโดยใช้ ตัวสร้างบทกวี AI ให้คลิกปุ่มคัดลอกเพื่อคัดลอกบทกวี จากนั้นวางลงในแพลตฟอร์มใดๆ ที่คุณต้องการส่งไป</p>`
  },
  id: {
    header_title: "Generator Puisi AI-Buat puisi berima dengan generator puisi AI gratis",
    header_title_category: "Semua Kategori Puisi - Generator Puisi AI",
    header_title_category_type: "%s1 %s2 - Generator Puisi AI",
    header_title_poem_type: "Puisi Tentang “%s” - Pembuat Puisi AI",
    header_title_poem: "%s puisi berkualitas tinggi dihasilkan oleh AI - Generator Puisi AI",
    Description_poem_type: "Temukan puisi ini di 'Pembuat Puisi AI', sebuah perjalanan puisi. Ciptakan puisi berirama unik dengan keajaiban AI gratis di sini",
    Description_category_type: "Temukan %s1 %s2 berkualitas tinggi. Buat puisi berima unik dengan sihir AI gratis sekarang!",
    ...
    Description_poem: "Temukan %s puisi buatan AI berkualitas tinggi. Buat puisi berima unik secara instan, gratis untuk digunakan. Buat dan nikmati puisi indah sekarang!",
    ...
    <h1>Apakah Generator Puisi AI gratis?</h1>
<p>Ya, ini sepenuhnya gratis. Anda dapat membuat puisi tanpa batas menggunakan Generator Puisi AI</p>

<h1>Seberapa cepat kecepatan pembuatan puisi Generator Puisi AI?</h1>
<p>Sangat cepat. Menggunakan Generator Puisi AI, sebuah puisi biasanya dibuat untuk Anda dalam hitungan detik</p>

<h1>Bahasa apa saja yang didukung oleh Generator Puisi AI?</h1>
<p>Generator Puisi AI mendukung pembuatan puisi dalam bahasa Inggris, Prancis, Rusia, Jerman, Italia, Spanyol, Portugis, Jepang, Korea, Thailand, Indonesia, Vietnam, Arab, dan Turki</p>

<h1>Bagaimana cara kerja Generator Puisi AI?</h1>
<p>Generator Puisi AI menggunakan kekuatan AI untuk membantu semua orang menulis puisi berkualitas tinggi dengan mudah</p>

<h1>Bagaimana cara menggunakan puisi yang dihasilkan oleh Generator Puisi AI?</h1>
<p>Setelah membuat puisi menggunakan Generator Puisi AI, klik tombol salin untuk menyalin puisi tersebut, lalu tempelkan ke platform mana pun tempat Anda ingin mengirimkannya.</p>
`
  },
  vi: {
    header_title: "Trình Tạo Thơ AI - Tạo bài thơ có vần điệu bằng AI miễn phí",
    header_title_category: "Tất cả danh mục bài thơ - Trình Tạo Thơ AI",
    header_title_category_type: "%s1 %s2 - Trình Tạo Thơ AI",
    header_title_poem_type: "Bài Thơ Về “%s” - Trình Tạo Thơ AI",
    header_title_poem: "%s bài thơ chất lượng cao được tạo bởi AI - Trình Tạo Thơ AI",
    Description_poem_type: "Khám phá bài thơ này trên 'Trình Tạo Thơ AI', một hành trình thơ. Tạo một bài thơ vần độc đáo với phép thuật AI miễn phí tại đây",
    Description_category_type: "Khám phá %s1 %s2 chất lượng cao. Tạo bài thơ có vần điệu độc đáo với phép thuật AI miễn phí ngay bây giờ!",
    ...
    Description_poem: "Khám phá %s bài thơ chất lượng cao do AI tạo ra. Tạo những bài thơ có vần điệu độc đáo ngay lập tức, miễn phí sử dụng. Tạo và thưởng thức những bài thơ tuyệt vời ngay bây giờ!",
    ...
    <h1>Trình Tạo Thơ AI có miễn phí không?</h1>
<p>Vâng, nó hoàn toàn miễn phí. Bạn có thể tạo những bài thơ không giới hạn bằng cách sử dụng Trình Tạo Thơ AI</p>

<h1>Tốc độ tạo thơ của Trình Tạo Thơ AI nhanh đến mức nào?</h1>
<p>Rất nhanh. Sử dụng Trình Tạo Thơ AI, một bài thơ thường được tạo cho bạn trong vài giây</p>

<h1>Trình Tạo Thơ AI hỗ trợ những ngôn ngữ nào?</h1>
<p>Trình Tạo Thơ AI hỗ trợ sáng tác thơ bằng tiếng Anh, tiếng Pháp, tiếng Nga, tiếng Đức, tiếng Ý, tiếng Tây Ban Nha, tiếng Bồ Đào Nha, tiếng Nhật, tiếng Hàn, tiếng Thái, tiếng Indonesia, tiếng Việt, tiếng Ả Rập và tiếng Thổ Nhĩ Kỳ</p>

<h1>Trình Tạo Thơ AI hoạt động như thế nào?</h1>
<p>Trình Tạo Thơ AI sử dụng sức mạnh của AI giúp mọi người dễ dàng viết những bài thơ chất lượng cao</p>

<h1>Làm thế nào để sử dụng những bài thơ được tạo ra bởi Trình Tạo Thơ AI?</h1>
<p>Sau khi tạo một bài thơ bằng cách sử dụng Trình Tạo Thơ AI, hãy nhấp vào nút sao chép để sao chép bài thơ rồi dán vào bất kỳ nền tảng nào bạn muốn gửi đến.</p>
`
  },
  ar: {
    header_title: "مولد الشعر الآلي - كتابة قصائد موزونة مجانًا بالذكاء الاصطناعي",
    header_title_category: "جميع فئات القصائد | مولد الشعر الآلي",
    header_title_category_type: "%s1 %s2 | مولد الشعر الآلي",
    header_title_poem_type: "قصيدة عن '%s' - مولد الشعر الآلي",
    header_title_poem: "قصائد %s المكتوبة بالذكاء الاصطناعي - مولد الشعر الآلي",
    Description_poem_type: "اكتشف هذه القصيدة على “مولد الشعر الآلي”، رحلة شعرية. أنشئ قصيدة مقفاة فريدة من نوعها باستخدام سحر الذكاء الاصطناعي المجاني هنا",
    Description_category_type: "اكتشف %s1 %s2 عالية الجودة. أنشئ قصيدة مقافية فريدة باستخدام سحر الذكاء الاصطناعي مجانًا الآن!",
    ...
    Description_poem: "اكتشف %s قصيدة عالية الجودة تم إنشاؤها بواسطة الذكاء الاصطناعي. أنشئ قصائد مقافية فريدة من نوعها على الفور، وهي مجانية الاستخدام. إنشاء والاستمتاع بقصائد رائعة الآن!",
    ...
    <h1>هل مولد الشعر الآلي مجاني؟</h1>
<p>نعم، إنه مجاني تماما. يمكنك إنشاء عدد غير محدود من القصائد باستخدام مولد الشعر الآلي</p>

<h1>ما مدى سرعة إنشاء القصيدة في مولد الشعر الآلي؟</h1>
<p>سريع جدا. باستخدام مولد الشعر الآلي، عادةً ما يتم إنشاء قصيدة لك في ثوانٍ</p>

<h1>ما هي اللغات التي يدعمها مولد الشعر الآلي؟</h1>
<p>يدعم مولد الشعر الآلي إنشاء الشعر باللغات الإنجليزية والفرنسية والروسية والألمانية والإيطالية والإسبانية والبرتغالية واليابانية والكورية والتايلاندية والإندونيسية والفيتنامية والعربية والتركية.</p>

<h1>كيف يعمل مولد الشعر الآلي؟</h1>
<p>يستخدم مولد الشعر الآلي قوة الذكاء الاصطناعي لمساعدة الجميع على كتابة قصائد عالية الجودة بسهولة</p>

<h1>كيفية استخدام القصائد التي تم إنشاؤها بواسطة مولد الشعر الآلي؟</h1>
<p>بعد إنشاء قصيدة باستخدام مولد الشعر الآلي، انقر فوق زر النسخ لنسخ القصيدة ثم لصقها على أي منصة تريد إرسالها إليها.</p>`
  },
  tr: {
    header_title: "Yapay Zeka Şiir Üretici - Yapay zeka ile ücretsiz kafiyeli şiirler yazın",
    header_title_category: "Tüm Şiir Kategorileri - Yapay Zeka Şiir Üretici",
    header_title_category_type: "%s1 %s2 - Yapay Zeka Şiir Üretici",
    header_title_poem_type: "“%s” Hakkında Bir Şiir - Yapay Zeka Şiir Üretici",
    header_title_poem: "Yapay Zeka Kullanılarak Üretilen %s Şiir - Yapay Zeka Şiir Oluşturucu",
    Description_poem_type: "Bu şiiri Yapay Zeka Şiir Üretici da keşfedin, bir şiir yolculuğu. Burada ücretsiz AI büyüsüyle benzersiz bir kafiyeli şiir yaratın",
    Description_category_type: "%s1 yüksek kaliteli %s2'i keşfedin. Şimdi ücretsiz olarak AI büyüsüyle benzersiz kafiyeli şiir yaratın!",
    ...
    Description_poem: "Yapay zeka tarafından oluşturulan %s yüksek kaliteli şiiri keşfedin. Anında, kullanımı ücretsiz, benzersiz kafiyeli şiirler oluşturun. Şimdi harika şiirler yaratın ve tadını çıkarın!",
    ...
    <h1>Yapay Zeka Şiir Üretici ücretsiz mi?</h1>
    <p>Evet, tamamen ücretsizdir. "AI Poem Generator"ı kullanarak sınırsız şiir oluşturabilirsiniz</p>

    <h1>Yapay Zeka Şiir Üretici ın şiir oluşturma hızı ne kadar hızlı?</h1>
    <p>Çok hızlı. Yapay Zeka Şiir Üretici ı kullanarak genellikle saniyeler içinde sizin için bir şiir oluşturulur</p>

    <h1>Yapay Zeka Şiir Üretici hangi dilleri destekliyor?</h1>
    <p>Yapay Zeka Şiir Üretici İngilizce, Fransızca, Rusça, Almanca, İtalyanca, İspanyolca, Portekizce, Japonca, Korece, Tayca, Endonezce, Vietnamca, Arapça ve Türkçe dillerinde şiir oluşturmayı destekler</p>

    <h1>Yapay Zeka Şiir Üretici nasıl çalışır?</h1>
    <p>Yapay Zeka Şiir Üretici herkesin kolayca yüksek kaliteli şiirler yazmasına yardımcı olmak için yapay zekanın gücünü kullanıyor</p>

    <h1>Yapay Zeka Şiir Üretici tarafından oluşturulan şiirler nasıl kullanılır?</h1>
    <p>Yapay Zeka Şiir Üretici kullanarak bir şiir oluşturduktan sonra, şiiri kopyalamak için kopyala butonuna tıklayın ve göndermek istediğiniz herhangi bir platforma yapıştırın.</p>`
  }
}
